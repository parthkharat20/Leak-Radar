    ...
    <div className={cn("w-full", embedded ? "max-w-none" : "max-w-3xl mx-auto")}>
      <div className="space-y-6">
        ...
        {!showManualInput ? (
          <div className="space-y-5">
            ...
            >
              ...
              {isLoading ? (
                ...
                <>
                  <div className="w-14 h-14 rounded-full bg-[#c9e0fc]/50 border border-[#024ad8]/20 flex items-center justify-center text-[#024ad8]">
            ...
            {!isLoading && (
              <div className="text-center">
                <button
                  ...
                  className="text-xs font-semibold text-[#024ad8] hover:underline uppercase tracking-wider"
                >
          ...
          <form onSubmit={handleManualSubmit} className="hp-card p-6 space-y-5">
